...
There is no reliable, automated method.<br />
...
Assuming a volume has text, and assuming Imaging Services has OCR software capable of processing the languages, and character set,<br />Imaging Services creates image-based PDFs with imperfect indexes for searching.
