...
Given a choice, this is the PDF you want. The text is encoded descriptively: This font, at this size, should be rendered in this specific location on the page, or *canvas*. The font is described as a shape and can be scaled to any size output without degradation.
...
* These PDFs may have images of text, but the text cannot be searched. The PDF is just a sequence of images--grids of color and tone values.

* These files are frequently too large to open and navigate easily. Images can be large, and a stack of images is large multiplied the number of page-images included.
...
## Searchable, image-based PDFs, shortcommings
