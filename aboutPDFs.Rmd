...
Assuming a volume has text, and assuming Imaging Services has<br />OCR software capable of processing the languages, and character set,<br /><br />

Imaging Services creates image-based PDFs with imperfect indexes for searching.
