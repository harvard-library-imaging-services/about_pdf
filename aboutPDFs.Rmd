...
When digitizing library materials, can we find a way to <mark>stop making PDFs for preservation and access</mark>?

## Digitized Harvard theses & dissertations

When digitizing paper theses, why are we making PDFs?

* Because we cannot make the digitized copies accessible online. (<mark>Why?</mark>)
* Because we extend access on-demand by secretly making the PDF link live, briefly, so a specifc patron can download a copy.
* Because the *P* is for portable. Acrobat is ubiquitous and provides a portable UI for offline use.
...
* Too hard to decompose into page-images for computation.
...
## *"I don't understand, I love PDFs."*
