...
The text is encoded descriptively:<br />*This font, at this size, should be rendered in this specific location on the page*, or *canvas*.<br />The font is described as a shape at a location, and therefore can be scaled to any size output without degradation.
